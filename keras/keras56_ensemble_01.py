...
# 2-3 concatnate
# merge1 = concatenate([output1, output11], name='mg1') # 단순 함수형
merge1 = Concatenate(name='mg1')([output1, output11], ) # 클래스 호출
merge2 = Dense(7, name='mg2')(merge1)
merge3 = Dense(11, name='mg3')(merge2)
last_output = Dense(1, name='last')(merge3)


model = Model(inputs=[input1, input11], outputs=last_output)     # 두 개 이상은 리스트
...
# 로스 :  0.009031041525304317
# R2 :  0.9999883589930382
