...
history = model.fit(x_train, y_train, epochs=100, batch_size=1000, verbose= 0, validation_split=0.2, callbacks=[es,rlr])
...
==============================
ReduceLR
로스 : [0.41358625888824463, 0.8502596020698547]
ACC : 0.8502596053997923
'''